...
export const projects: Project[] = [
  {
    ...
    cover: '/assets/YinYang/yinyang-cover.png',
    banner: '/assets/YinYang/yinyang-cover.png',
    moneyshot: '/assets/YinYang/yinyang-cover.png',
    demo: '/yinyang/index.html',
    hideDownload: true,
    status: 'Live web app',
    overview: {
    ...
    technical: [
      {
        ...
        media: '/assets/YinYang/yinyang-cover.png',
      },
      {
