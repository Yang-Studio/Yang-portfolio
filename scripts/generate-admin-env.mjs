...
const values = {
  ...
  ADMIN_PASSWORD_HASH: `scrypt$${salt.toString('hex')}$${passwordHash.toString('hex')}`,
...
console.log('Store the password in a password manager. It cannot be recovered from ADMIN_PASSWORD_HASH.')
