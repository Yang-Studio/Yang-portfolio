...
export const projectTranslations: Record<string, ProjectTranslation> = {
  ...
  yinyang: {
    ...
    process: [
      { title: '问题', body: '传统八字工具界面杂乱、术语堆砌，很多结论隐藏了计算路径和适用边界。' },
      { title: '做法', body: '把出生信息、历法转换、五行结构和解读内容拆成清晰层级，让用户先看数据，再看解释。' },
      { title: '信任', body: '网页版无需账号和后端，数据保存在本机；解读内容说明依据和边界，不把推测包装成绝对结论。' },
    ],
    technical: [
      {
        title: '精确排盘',
        description: '按节气边界推导四柱，支持农历闰月换算与可选真太阳时校正，避免只按自然月份粗略处理。',
      },
      {
        title: '五行结构',
        description: '将天干、地支和藏干转换为归一化的五行结构，用进度条和雷达图呈现整体倾向。',
      },
      {
        title: '可审计解读',
        description: '日主强弱、喜用倾向和结构说明来自显式规则，而不是不可追溯的固定文案。',
      },
      {
        title: '带依据的推测',
        description: '事业、财富、感情、学业、健康和时机模块分别说明推断边界；健康内容明确为非医疗建议。',
      },
      {
        title: '可互动·可嵌入',
        description: '支持今日运势、缘分配对、历史记录、偏好设置和分享海报，也可通过 iframe 与 postMessage 嵌入其他页面。',
      },
    ],
    results: {
      summary: '天機閣把密集命盘整理成可用的网页产品：计算过程透明、解读边界清楚，用户隐私数据留在本地。',
      highlights: ['按节气精确排盘', '透明规则分析', '本地运行、可嵌入、无需账号'],
    },
  },
  shanhe: {
    title: '山河',
